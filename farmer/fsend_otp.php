...
if($count>0){
	...
	$html="Your otp verification code for Safir Farms is ".$otp;
...
function smtp_mailer($to,$subject, $msg){
	...
	$mail->IsHTML(true);
	$mail->CharSet = 'UTF-8';
	$mail->Username = "vladimofm19@gmail.com";   
    $mail->Password = "mmnlezsscnredowr"; 	
    $mail->SetFrom("vladimofm19@gmail.com");  
