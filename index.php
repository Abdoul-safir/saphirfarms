        ...
        <div class="container">
          <div class="row row-header">
            <div class="col-12 col-sm-6">
              <h1 class="text-white">Safir Farms</h1>
              <p class="text-white">
      ...
      <div class="container ">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
           ...
           <p class=" ">Unlock the power of modern farming technology. Access personalized crop and fertilizer recommendations, stay ahead of the weather with accurate forecasts, and stay informed with the latest agricultural news. Sell your produce directly to customers hassle-free. Welcome to a new era of farming efficiency.</p>
          ...
          <div class="col-lg-6 col-10 mx-md-auto d-none d-md-block">
            <img class="ml-lg-5  pull-right" src="assets/img/smart_farm12.png" width="100%">
          </div>
        </div>
		        ...
		        <div class="row align-items-center">
				  <div class="col-lg-6 col-10 mx-md-auto d-none d-md-block">
            <img class="ml-lg-5" src="assets/img/customer12.png" width="80%">
          </div>
...
const apiKey = "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";   // Enter your apikey here
